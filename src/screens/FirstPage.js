...
const FirstPage = ({setScreen,user}) => {
        ...
        <View>
            <ImageBackground source={image} resizeMode='cover' style={{ height: '100%', width: '100%' }}>
                <View style={{ height: '55%', width: '100%', position: 'absolute', backgroundColor: 'rgba(0,0,0,0.5)', borderRadius: 20 }}>
                    ...
                    <TouchableOpacity onPress={() => setScreen('Login')} style={{ zIndex: 1, position: 'absolute', marginLeft: 300, marginTop: 64, display: Drop ? "" : 'none' }}>
                        <Text style={{ color: 'white', paddingLeft: 7, paddingRight: 7, paddingTop: 5, paddingBottom: 5, width: 80, textAlign: 'center' }}>Logout</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => setScreen('Profile')} style={{ zIndex: 1, position: 'absolute', marginLeft: 300, marginTop: 94, display: Drop ? "" : 'none' }}>
                        <Text style={{ color: 'white', paddingLeft: 7, paddingRight: 7, paddingTop: 5, paddingBottom: 5, width: 80, textAlign: 'center' }}>Profile</Text>
                    </TouchableOpacity>
                    <Text style={{ fontSize: 25, color: 'white', position: 'relative', marginTop: -35, width: "100%", textAlign: 'center', paddingRight: 40, fontFamily: 'monospace' }}>{user.firstName}</Text>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center' }}>
                        <View style={{ height: 190, width: 150, marginTop: 5, borderRadius: 20, padding: 10, paddingBottom: 12 }}>
                            <Pressable style={{ margin: 0, padding: 0 }} onPress={() => setScreen('Explore')}>
                                <Image source={explore_img} resizeMode='contain' style={{ height: "90%", width: '100%', marginTop: 0 }}></Image>
                            </Pressable>
                            <Text style={{ textAlign: 'center', fontSize: 15, fontWeight: 'bold', color: 'white' }}>Explore Stories</Text>
                        </View>
                        <View style={{ height: 190, width: 150, marginTop: 5, borderRadius: 20, padding: 10, paddingBottom: 12 }}>
                            <Pressable style={{ margin: 0, padding: 0 }} onPress={() => setScreen("Capture")}>
                                <Image source={rec_img} resizeMode='contain' style={{ height: "82%", width: '100%', borderRadius: 20, marginTop: 4, marginBottom: 10, zIndex: 1 }}></Image>
                            </Pressable>
